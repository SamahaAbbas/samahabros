<p align="center">
<picture>
<img width="160" height="160"  alt="XPanel" src="https://raw.githubusercontent.com/SamahaAbbas/samahabros/tree/main/images/logo.png">
</picture>
  </p> 
<p align="center">
...
<p align="center">
<img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/SamahaAbbas/samahabros">
</p>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/samahabros/master/install.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/samahabros/master/update-panel.sh --ipv4)
```

## فعال سازی SSL

```
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/samahabros/master/ssl.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/samahabros/master/block-ir-ip.sh --ipv4)
```
